    ...
    <div class="container">
      <div class="card border-0 mt-5" style="max-width:auto;background: transparent;">
        <div class="card-body">
          <form>
            <div class="mb-3 mt-5">
              <h3 class="text-center ">Form Keluhan Nota Sampah Kapal</h3>
            </div>
            ...
            <div class="mb-3 row">
              <label for="inputnomornota" class="col-sm-2 col-form-label">Nomor Nota : </label>
              <div class="col-sm-7">
                <input type="text" class="form-control" id="inputnomornota">
              </div>
            </div>
            <div class="mb-3 row">
              <label for="inputdeskripsi" class="col-sm-2 col-form-label">Deskripsi Keluhan : </label>
              <div class="col-sm-7">
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="5"></textarea>
              </div>
            </div>
            <div class="mb-3 row">
              <label for="formFileMultiple" class="col-sm-2 form-label">Lampiran Pendukung : </label>
              <div class="col-sm-7">
