...
<head>
    ...
    <title>Pembuatan Berita Acara Nota Kapal</title>
        ...
        <div id="content">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    <h1>Surat Berita Acara Koreksi Nota Kapal</h1>
                </div>
            </nav>
                ...
                <div class="modal-dialog modal-dialog-scrollable">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Surat Berita Acara Koreksi Nota Kapal</h4>
            ...
            <table class="table table-bordered table text-center" style="background: transparent;">
                <thead>
                    <tr>
                        ...
                        <th class="align-text-top" scope="col">Nama Perusahaan</th>
                        <th class="align-text-top" scope="col">No Surat Perusahaan</th>
                        <th class="align-text-top" scope="col">Tanggal Surat</th>
                        <th class="align-text-top" scope="col">Perihal</th>
                        <th class="align-text-top" scope="col">Penjelasan</th>
                        <th class="align-text-top" scope="col">Nomor Nota Kapal</th>
                        <th class="align-text-top" scope="col">Keterangan</th>
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td>26821/BA-KNK/1/2021</td>
                        <td>10/9/2021</td>
                        <td>PT. SAMUDERA SHIPPING</td>
                        <td>SR.21.08.006/OPS</td>
                        <td>3/8/2021</td>
                        <td>Permohonan Pengajuan Koreksi Nota 0800102110007940 CALIDRIS. MV periode kunjungan 25/07/2021 s.d 26/07/2021.</td>
                        <td>a.Berdasarkan Surat Keputusan Direksi PT. Pelabuhan Indonesia II (Persero)
                            b.Pengenaan denda pasal 5.2b pada kapal MV. WINTER
                        </td>
                        <td>0800102110007940</td>
                        <td>Koreksi Pasal 5.2b SK. Dir</td>
                        <td>Budi</td>
                        <td>
                            <form action="file/PenerimaanKP.pdf" method="get">
                                <button type="submit" style="background: transparent; border: none;">notakapal.pdf</button>
                            </form>
                        </td>
                        <td>
