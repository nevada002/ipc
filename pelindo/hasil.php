...
<html lang="en">
  <head>
    ...
    <title>Tracking Proggress</title>
    ...
    <div class="container">
      <div class="card border-0 mt-5" style="max-width:auto; background: transparent;">
          <div class="card-body">
            <form>
              <div class="mb-3 mt-5">
                <h3 class="text-center ">Hasil Berita Acara Keluhan Nota</h3>
              </div>
              <table class="table table-bordered table" style="background: transparent;">
                <thead>
                  <tr>
                    <th scope="col">No</th>
